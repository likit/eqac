...
all_tests = {
                ...
                4: [(19,20,21,22,23,24), (10,11,9,1,8,7), 15.50], # ast
                ...
                15: [(76,77,78,79,80), (4,33,6,1,7), 13.2], # ldh
                16: [(81,82), (30,32), 15.0], # ldl
                17: [(83,84,85), (34,35,1), 7.8], # Inor.P
                18: [(86,87,88), (20,21,1), 2.9], # Potassium
                19: [(92,93,94), (36,37,1), 3.9], # Protein
                20: [(95,96,97), (20,21,1), 1.6], # sodium
                21: [(101,102,103,104,105), (38,39,1,8,9), 14.0], # triglyceride
                22: [(106,107,108,109,110), (40,41,1,8,9), 7.7], # uric acid
            }
